...
This killer travelled extensively.  This mapconnects the dots between his routes from date to date.

```{r routes_map, fig.align="center"}
...
```{r durations_map, fig.align="center"}
#make the sf object
